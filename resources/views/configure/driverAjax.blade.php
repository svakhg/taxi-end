    ...
    <div class="modal-body">
        ...
        <div class="col-md-10">
            <div class="row" style="margin-left:10px">
                ...
                <h4 style="display: inline; padding-left:30px"><strong>Taxi Center: </strong>{{ $driver->taxi->callcode->taxicenter->name }}</h4>
                <h4 style="display: inline; padding-left:30px"><strong>Taxi No: </strong>{{ $driver->taxi->taxiNo }}</h4>
                <h4 style="display: inline; padding-left:30px"><strong>Driver Name: </strong>{{ $driver->driverName }}</h4>
                <hr style="clear:both;"/>
            </div>
