            ...
            <div class="modal-body">
                ...
                <div class="form-group" style="z-index:2151 !important;">
                    ...
                    <div class="input-group date">
                        <input name="driverLicenceExp" id="driverLicenceExp" class="datepicker form-control" data-date-format="dd/mm/yyyy" type="text" value="<?php echo date('d/m/Y') ?>">
                    </div>
                </div>
                ...
                <div class="form-group" style="z-index:2151 !important;">
                    ...
                    <div class="input-group date">
                        <input name="driverPermitExp" id="driverPermitExp" class="datepicker form-control" data-date-format="dd/mm/yyyy" type="text" value="<?php echo date('d/m/Y') ?>">
                    </div>
                </div>
