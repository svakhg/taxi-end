        ...
        <div class="col-md-10">
            ...
            <div class="row" style="margin-left:10px">
                ...
                <div style="display: inline;float: left; font-size:23px; width:50%; height:100%">
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                        <li>Driver Mobile: <?php echo e($driver->driverMobile); ?></li>
                        <li>Driver Licence No: <?php echo e($driver->driverLicenceNo); ?></li>
                        <li>Driver Id Card No: <?php echo e($driver->driverIdNo); ?></li>
                    </ul>
                </div> 
            </div> 
        </div>
